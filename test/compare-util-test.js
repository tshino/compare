...
(function(){
  ...
  TEST( 'compareUtil detectImageFormat GIF', function test() {
    ...
    EXPECT_EQ( 'Indexed RGB 8.8.8 (2bpp)', f.color );
    EXPECT_EQ( 2, f.anim && f.anim.frameCount );
    EXPECT_EQ( 14, f.anim && f.anim.durationNum );
    EXPECT_EQ( 100, f.anim && f.anim.durationDen );
    EXPECT_EQ( 100, f.anim && f.anim.fpsNum );
    EXPECT_EQ( 7, f.anim && f.anim.fpsDen );
    EXPECT( f.anim && f.anim.approxFPS && 0.05 >= Math.abs(100/7 - f.anim.approxFPS) );
  ...
  TEST( 'compareUtil detectImageFormat WebP', function test() {
    ...
    EXPECT_EQ( 1000, f.anim && f.anim.durationDen );
    EXPECT_EQ( 1000, f.anim && f.anim.fpsNum );
    EXPECT_EQ( 40, f.anim && f.anim.fpsDen );
    EXPECT( f.anim && f.anim.approxFPS && 0.05 >= Math.abs(25 - f.anim.approxFPS) );
    ...
    EXPECT_EQ( 1000, f.anim && f.anim.durationDen );
    EXPECT_EQ( 1000, f.anim && f.anim.fpsNum );
    EXPECT_EQ( 70, f.anim && f.anim.fpsDen );
    EXPECT( f.anim && f.anim.approxFPS && 0.05 >= Math.abs(100/7 - f.anim.approxFPS) );
    ...
    EXPECT_EQ( 'YCbCr 8.8.8 (12bpp 4:2:0)', f.color );
    EXPECT_EQ( 4, f.anim && f.anim.frameCount );
    EXPECT_EQ( 300, f.anim && f.anim.durationNum );
    EXPECT_EQ( 1000, f.anim && f.anim.durationDen );
    EXPECT_EQ( null, f.anim && f.anim.fpsNum );
    EXPECT_EQ( null, f.anim && f.anim.fpsDen );
    EXPECT( f.anim && f.anim.approxFPS && 0.05 >= Math.abs(1000/75 - f.anim.approxFPS) );
    ...
    EXPECT_EQ( 'WebP (Animated Lossy+Lossless)', f.toString() );
    EXPECT_EQ( 'RGB 8.8.8 (24bpp), YCbCr 8.8.8 (12bpp 4:2:0)', f.color );
    EXPECT_EQ( 2, f.anim && f.anim.frameCount );
    EXPECT_EQ( 140, f.anim && f.anim.durationNum );
    EXPECT_EQ( 1000, f.anim && f.anim.durationDen );
    EXPECT_EQ( 1000, f.anim && f.anim.fpsNum );
    ...
    EXPECT_EQ( 'WebP (Animated Lossy+Lossless)', f.toString() );
    EXPECT_EQ( 'RGBA 8.8.8.8 (32bpp), YCbCr 8.8.8 (12bpp 4:2:0)', f.color );
    EXPECT_EQ( 2, f.anim && f.anim.frameCount );
    EXPECT_EQ( 140, f.anim && f.anim.durationNum );
    EXPECT_EQ( 1000, f.anim && f.anim.durationDen );
    EXPECT_EQ( 1000, f.anim && f.anim.fpsNum );
    ...
    EXPECT_EQ( 'WebP (Animated Lossy+Lossless)', f.toString() );
    EXPECT_EQ( 'RGB 8.8.8 (24bpp), YCbCr 8.8.8 (12bpp 4:2:0) + Alpha 8', f.color );
    EXPECT_EQ( 2, f.anim && f.anim.frameCount );
    EXPECT_EQ( 140, f.anim && f.anim.durationNum );
    EXPECT_EQ( 1000, f.anim && f.anim.durationDen );
    EXPECT_EQ( 1000, f.anim && f.anim.fpsNum );
    ...
    EXPECT_EQ( 'WebP (Animated Lossy+Lossless)', f.toString() );
    EXPECT_EQ( 'RGBA 8.8.8.8 (32bpp), YCbCr 8.8.8 (12bpp 4:2:0) + Alpha 8', f.color );
    EXPECT_EQ( 2, f.anim && f.anim.frameCount );
    EXPECT_EQ( 140, f.anim && f.anim.durationNum );
    EXPECT_EQ( 1000, f.anim && f.anim.durationDen );
    EXPECT_EQ( 1000, f.anim && f.anim.fpsNum );
